...
public class ConsumerArrayAdapter extends ArrayAdapter<Consumer> implements
	...
	public ConsumerArrayAdapter(Activity context, List<Consumer> list) {
		super(context, com.generic.notice48hrs.R.layout.row_consumer_list, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null){
			...
			view = inflater.inflate(com.generic.notice48hrs.R.layout.row_consumer_list, null);

			TextView tvAcctNum = (TextView) view.findViewById(com.generic.notice48hrs.R.id.tvAccountNumber);
			TextView tvName = (TextView) view.findViewById(com.generic.notice48hrs.R.id.tvName);
			TextView tvAddress = (TextView) view.findViewById(com.generic.notice48hrs.R.id.tvAddress);
			TextView tvMetSer = (TextView) view.findViewById(com.generic.notice48hrs.R.id.tvMeterSerial);
		...
		if (c.isServed()) {
			holder.isProcess.setText("Yes");
		} else {
			holder.isProcess.setText("No");
		}	
				...
				for (Consumer consumer : consumers) {
					...
					case NAME:
						addIt = consumer.getName().toUpperCase()
								.indexOf(constraint.toString().toUpperCase()) > 0;
						break;
					case METER_SERIAL:
